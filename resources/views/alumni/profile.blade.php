                ...
                <ul class="nav nav-tabs zTabHead" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="profile-tab" data-bs-toggle="tab"
                            ...
                            aria-controls="profile-tab-pane" aria-selected="true">{{ __('Profile') }}</button>
                    </li>
                    <li class="nav-item" role="presentation">
                                    ...
                                    <div class="row rg-25">
                                        ...
                                        <div class="pb-40">
                                            <div class="upload-img-box profileImage-upload">
                                                <div class="icon"><img src="assets/images/icon/edit-2.svg"
                                                        alt="" /></div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="primary-form-group">
                                                <div class="primary-form-group-wrap">
                                                    <label for="epNickName"
                                                        class="form-label">{{ __('Nick Name') }}</label>
                                            ...
                                            <div class="primary-form-group">
                                                <div class="primary-form-group-wrap">
                                                    <label for="blood_group"
                                                        class="form-label">{{ __('Blood Group') }}<span
                                                    ...
                                                    <select class="primary-form-control form-select" id="blood_group"
                                                        ...
                                                        <option {{ $user->alumni?->blood_group == 'B+' ? 'selected' : '' }}
                                                            value="B+">B+</option>
                                                        <option
                                                            {{ $user->alumni?->blood_group == 'AB-' ? 'selected' : '' }}
                                                            value="AB-">AB−</option>
                                                        <option
                                                            {{ $user->alumni?->blood_group == 'AB+' ? 'selected' : '' }}
                                                            value="AB+">AB+</option>
                                        ...
                                        <div class="col-md-12">
                                            <div class="primary-form-group">
                                                <div class="primary-form-group-wrap">
                                                    ...
                                                    <textarea class="primary-form-control min-h-180" id="epAbout" name="about_me"
                                    ...
                                    <div class="row rg-25">
                                        ...
                                        <div class="col-md-6">
                                            <div class="primary-form-group">
                                                <div class="primary-form-group-wrap">
                                                    <label for="epEmail"
                                                        class="form-label">{{ __('Personal Email Address') }}</label>
                                                    <input type="email" value="{{ $user->email }}" name="email"
                                                        disabled class="primary-form-control" id="epEmail"
                                        ...
                                        <div class="col-md-6">
                                            <div class="primary-form-group">
                                                <div class="primary-form-group-wrap">
                                                    <label for="epTwitter"
                                                        class="form-label">{{ __('Twitter Url') }}</label>
                                                        ...
                                                        <div class="d-flex align-items-center cg-16">
                                                            <button type="button"
                                                                ...
                                                                data-bs-target="#addMoreModal">{{ __('+Add
                                                                                                                    More') }}</button>
                                                            <button type="button"
                                                                class="border-0 p-0 bg-transparent fs-14 fw-500 lh-17 text-ed0006 text-decoration-underline hover-color-one delete-education">{{ __('Delete') }}</button>
                                                        </div>
                                                    </div>
                                                @else
                                                    <div
                                                ...
                                                <div class="row rg-25">
                                                    <div class="col-md-6">
                                                        <div class="primary-form-group">
                                                            <div class="primary-form-group-wrap">
                                                                <label for="epDegree"
                                                                    class="form-label">{{ __('Degree') }}</label>
                                                        ...
                                                        <div class="primary-form-group">
                                                            <div class="primary-form-group-wrap">
                                                                <label for="epInstitute"
                                                                    class="form-label">{{ __('Institute') }}</label>
                                                                <input type="text"
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center cg-16">
                                                    <button type="button"
                                                        class="border-0 p-0 bg-transparent fs-14 fw-500 lh-17 text-1b1c17 text-decoration-underline hover-color-one"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#addMoreModal">{{ __('+Add New') }}</button>
                                                </div>
                                            </div>
                                            <div class="">
                                ...
                                <div class="pb-30">
                                    ...
                                    <div class="row rg-25">
                                        <div class="col-md-6">
                                            <div class="primary-form-group">
                                                <div class="primary-form-group-wrap">
                                                    <label for="epCompanyName"
                                                        class="form-label">{{ __('Company Name') }}</label>
                                                    <input type="text" value="{{ $user->alumni?->company }}"
                                                        name="company" class="primary-form-control" id="epCompanyName"
                                        ...
                                        <div class="col-md-6">
                                            <div class="primary-form-group">
                                                <div class="primary-form-group-wrap">
                                                    <label for="epDesignation"
                                                        class="form-label">{{ __('Designation') }}</label>
                                                    <input type="text"
                                                        value="{{ $user->alumni?->company_designation }}"
                                            ...
                                            <div class="primary-form-group">
                                                <div class="primary-form-group-wrap">
                                                    ...
                                                    <input type="text" class="primary-form-control"
                                                        value="{{ $user->alumni?->city }}" name="city"
                                                        id="epCity" placeholder="{{ __('Current Company City') }}" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="primary-form-group">
                                                <div class="primary-form-group-wrap">
                                                    <label for="epCity" class="form-label">{{ __('State') }} <span
                                                            class="text-danger">*</span></label>
                                                    <input type="text" class="primary-form-control"
                                                        value="{{ $user->alumni?->state }}" name="state"
                                                        id="epCity"
                                            ...
                                            <div class="primary-form-group">
                                                <div class="primary-form-group-wrap">
                                                    <label for="epCountry" class="form-label">{{ __('Country') }} <span
                                                            class="text-danger">*</span></label>
                                                    <input type="text" value="{{ $user->alumni?->country }}"
                                                        name="country" class="primary-form-control" id="epCountry"
                                            ...
                                            <div class="primary-form-group">
                                                <div class="primary-form-group-wrap">
                                                    <label for="epZipCode" class="form-label">{{ __('Zip Code') }} <span
                                                            class="text-danger">*</span></label>
                                                    <input type="text" value="{{ $user->alumni?->zip }}"
                                                        name="zip" class="primary-form-control" id="epZipCode"
                                            ...
                                            <div class="primary-form-group">
                                                <div class="primary-form-group-wrap">
                                                    <label for="epAddress" class="form-label">{{ __('Address') }} <span
                                                            class="text-danger">*</span></label>
                                                    <input type="text" value="{{ $user->alumni?->address }}"
                                                        name="address" class="primary-form-control" id="epAddress"
            ...
            <div class="modal-content zModalTwo-content">
                <div class="modal-body zModalTwo-body">
                    ...
                    <form method="POST" class="ajax" data-handler="commonResponseForModal"
                        ...
                        <div class="pb-25">
                            <div class="row rg-25">
                                <div class="col-12">
                                    <div class="primary-form-group">
                                        <div class="primary-form-group-wrap">
                                            ...
                                            <input type="text" class="primary-form-control" id="epDegree1"
                                                name="degree" placeholder="{{ __('Your Degree') }}" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <div class="primary-form-group">
                                        <div class="primary-form-group-wrap">
                                            <label for="epPassingYear1"
                                                class="form-label">{{ __('Passing Year') }}</label>
                        ...
                        <button type="submit"
                            class="py-13 px-26 bg-cdef84 border-0 bd-ra-12 fs-15 fw-500 lh-25 text-black hover-bg-one">{{ __('Save Now') }}</button>
                    </form>
                </div>
            </div>
        </div>

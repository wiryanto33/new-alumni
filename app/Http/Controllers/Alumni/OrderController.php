...
class OrderController extends Controller
{
    ...
    public function pay(OrderRequest $request)
    {
        ...
        $object = [
            ...
            'cancel_url' => route('checkout.success', ['success' => false, 'message' => __('Your payment has been failed')]),
    ...
    public function verify(Request $request)
    {
        ...
        if ($order->payment_status == PAYMENT_STATUS_PAID) {
            return redirect()->route('checkout.success', ['success' => false, 'message' => __('Your order has been already paid!')]);
        }

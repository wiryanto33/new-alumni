...
if(!function_exists("transactionType")){
    function transactionType($input = null)
    {
        $output = [
            ...
            TRANSACTION_DONATION => __("Donation"),
            TRANSACTION_NOMINATION => __("Nomination"),
        ];
...
if(!function_exists("superAdminSetting")){
    function superAdminSetting($input = null): array|string
    {
        $output = [
            ...
            'app_mail_status',
            'cname_information',
            'sa_app_primary_color',
            'sa_app_hover_color',
            'sa_app_text_color',
            'sa_app_text_body_color',
            'sa_app_gradiant1_color1',
            'sa_app_gradiant1_color2',
            'sa_gradiant1_color',
            'sa_inner_gradient_color_1',
            'sa_inner_gradient_color_2',
            'sa_inner_gradient_color',
            'sa_app_sidebar_bg_color',
            'sa_app_sidebar_text_color',
            'sa_app_color_design_type',
            'sa_custom_js',
            'sa_custom_css',
            'app_debug',
            'force_ssl'
...
if(!function_exists("getAddonAppNameList")){
    ...
    {
        $output = ['ALUSAAS', 'ALUCOMMITTEE', 'ALUDONATION'];
